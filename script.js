...
const calendertable = document.querySelector(".tableCon");
const alarmtable = document.querySelector(".alarmCon");
const todaybtn = document.querySelector("#today");
const upcomingbtn = document.querySelector("#upcoming");
const fil = document.querySelector("#filter");

const host_sites=['codeforces.com','codechef.com','atcoder.jp','leetcode.com','codingninjas.com/codestudio','hackerearth.com','geeksforgeeks.org','topcoder.com'];
const hosts = `codechef.com%2Ccodeforces.com%2Cgeeksforgeeks.org%2Chackerearth.com%2Cleetcode.com%2Ctopcoder.com%2Catcoder.jp%2Ccodingninjas.com/codestudio`;
let today = false;
...
if (localStorage.getItem('host-sites') === null) { host = host_sites; localStorage.setItem('host-sites', JSON.stringify(host_sites));} 
 ...
 const apiUrl=`https://cp-buzz-backend.vercel.app/upcomingContests/?`;
...
function fetchAlarm(){
	...
	if (alarmArray1.length===0) {
		alarmtable.innerHTML = `
		    <div class="emptyAlarm">
			No alarms found<br>
			Set reminders for your important contests here
			</div>
		`
		return;
	}
